...
class LecturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecturer" do
    assert_difference("Lecturer.count") do
      post lecturers_url, params: { lecturer: { first_name: @lecturer.first_name, last_name: @lecturer.last_name, user_id: @lecturer.user_id } }
    end
  ...
  test "should update lecturer" do
    patch lecturer_url(@lecturer), params: { lecturer: { first_name: @lecturer.first_name, last_name: @lecturer.last_name, user_id: @lecturer.user_id } }
